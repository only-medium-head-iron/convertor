...
(
    ...
    sign_required bit(1)       not null default 0 comment '是否校验签名',
...
(
    ...
    request_message  text            not null comment '请求报文',
    response_message text            not null comment '响应报文',
    request_result   bit(1)          not null comment '请求结果',
