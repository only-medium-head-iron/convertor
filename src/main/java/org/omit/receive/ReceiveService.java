...
import org.omit.AbstractService;
import org.omit.Convertor;
import org.omit.constant.Const;
import org.omit.enums.MethodEnum;
import org.omit.enums.ResultCode;
import org.omit.exception.ConvertException;
import org.omit.model.*;
import org.omit.rule.RuleMapping;
import org.omit.util.MessageFormatter;
...
//        ApiServiceDO apiService = context.getApiService();
     ...
     * @throws ServiceException 如果请求消息既不是JSON也不是XML格式，则抛出转换错误的服务异常
     */
    private void setParams(Context context, String reqMsg) {
        ...
        try {
            ...
            throw new ServiceException("请求报文不是JSON或XML格式");
        }
